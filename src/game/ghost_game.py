...
LEVELS: List[LevelConfig] = [
    LevelConfig(level_id=1, n_ghosts=1, radius=0.22, positions=[(0.50, 0.50)],
                moving=False, time_limit=20.0, threshold=0.60,
                label="Level 1 - Centre, facile"),
    LevelConfig(level_id=2, n_ghosts=1, radius=0.15, positions=[(0.25, 0.40)],
                moving=False, time_limit=20.0, threshold=0.62,
                label="Level 2 - Lateral, plus petit"),
    LevelConfig(level_id=3, n_ghosts=1, radius=0.10, positions=[(0.75, 0.65)],
                moving=False, time_limit=22.0, threshold=0.65,
                label="Level 3 - Petit, coin difficile"),
    LevelConfig(level_id=4, n_ghosts=1, radius=0.09, positions=[(0.50, 0.50)],
                moving=True, speed=0.18, time_limit=25.0, threshold=0.65,
                label="Level 4 - Fantome mobile"),
    LevelConfig(level_id=5, n_ghosts=2, radius=0.08,
